/*
 *  FILE          :	FadeCanvasIn.cs
 *  PROJECT       :	CORE Engine
 *  PROGRAMMER    :	Kastriot Sulejmani
 *  FIRST VERSION :	2020-11-07
 *  
 *  DESCRIPTION   : 
 *		Play "FadeCanvasIn" animation ... you need a canvas group component on this object in order for fade to work
 */
...
public class FadeCanvasIn : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        attachedCanvasAnim.Play("FadeCanvasIn");
    }
}
