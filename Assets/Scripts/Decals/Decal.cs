...
namespace ThreeEyedGames
{
    ...
    public class Decal : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            tagValue = Material.GetTag("Decal", false, "").ToUpper();
        }
        ...
        void OnWillRenderObject()
        {
            ...
            if (!Application.isPlaying)
            {
                ...
                RenderDecal(renderer);
                return;
            }
#endif
            RenderDecal(DecaliciousRenderer.singleton);
        }

        private void RenderDecal(DecaliciousRenderer renderer)
        {
            ...
            if (tagValue.Equals("DEFERRED"))
                RenderMode = DecalRenderMode.Deferred;
            else if (tagValue.Equals("UNLIT"))
