...
{
	/// <summary>
	///		Procedural cable generation <para/> 
	///		Package: <see href="https://assetstore.unity.com/packages/tools/particles-effects/real-time-procedural-cable-simple-102196">Real-Time Procedural Cable Simple</see> <para/>
	///		Author: <see href="https://assetstore.unity.com/publishers/31250">DrinkingWindGames</see>
	/// </summary>
